...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/neurodocker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9218&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/neurodocker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `neurodocker` can be installed with:

```
conda install neurodocker
```

It is possible to list all of the versions of `neurodocker` available on your platform with:
